...
This is a financial news aggregator with AI-powered stock predictions.
...
You can edit this project using your preferred code editor such as:
...
# Step 4: Start the web preview in your browser with auto-reloading
bun run start-web
...
1. **iOS**: Download [Expo Go from the App Store](https://apps.apple.com/app/expo-go/id982107779)
2. **Android**: Download [Expo Go from Google Play](https://play.google.com/store/apps/details?id=host.exp.exponent)
...
- Visit the [BIAZ Finance documentation files](./DOCUMENTATION_INDEX.md) for project-specific information

## About This Project

BIAZ Finance is built with React Native and Expo - the same technology stack used by Discord, Shopify, Coinbase, Instagram, and nearly 30% of the top 100 apps on the App Store.

The app is production-ready and can be published to both the App Store and Google Play Store. You can also export it to run on the web, making it truly cross-platform.
